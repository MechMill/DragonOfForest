...
public class RedForestBiome {
	public static final Climate.ParameterPoint PARAMETER_POINT = new Climate.ParameterPoint(Climate.Parameter.span(0.190476190477f, 0.476190476191f),
			...
			Climate.Parameter.span(-0.943027148348f, -0.657312862634f), 0);

	public static Biome createBiome() {
		BiomeSpecialEffects effects = new BiomeSpecialEffects.Builder().fogColor(12638463).waterColor(-39836).waterFogColor(-39836).skyColor(7972607)
				.foliageColorOverride(-39836).grassColorOverride(-3644316).build();
		BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder();
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, PlacementUtils.register("dragonofforest:tree_red_forest",
				FeatureUtils.register("dragonofforest:tree_red_forest", Feature.TREE,
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("dragonofforest:grass_red_forest", VegetationFeatures.PATCH_GRASS,
						List.of(NoiseThresholdCountPlacement.of(-0.8D, 5, 6), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE,
								BiomeFilter.biome())));
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("dragonofforest:flower_red_forest", VegetationFeatures.FLOWER_DEFAULT, List.of(CountPlacement.of(4),
