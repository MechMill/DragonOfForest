...
package net.mcreator.dragonofforest.world.biome;
...
public class BlueForestBiome {
	public static final Climate.ParameterPoint PARAMETER_POINT = new Climate.ParameterPoint(Climate.Parameter.span(0.190476190477f, 0.476190476191f),
			...
			Climate.Parameter.span(-0.145924993672f, 0.139789292042f), 0);

	public static Biome createBiome() {
		BiomeSpecialEffects effects = new BiomeSpecialEffects.Builder().fogColor(12638463).waterColor(-10197761).waterFogColor(-10197761)
				.skyColor(7972607).foliageColorOverride(-10197761).grassColorOverride(-10197816).build();
		BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder();
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, PlacementUtils.register("dragonofforest:tree_blue_forest",
				FeatureUtils.register("dragonofforest:tree_blue_forest", Feature.TREE,
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("dragonofforest:grass_blue_forest", VegetationFeatures.PATCH_GRASS,
						List.of(NoiseThresholdCountPlacement.of(-0.8D, 5, 4), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE,
								BiomeFilter.biome())));
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("dragonofforest:flower_blue_forest", VegetationFeatures.FLOWER_DEFAULT, List.of(CountPlacement.of(2),
